...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # self.out_proj = nn.Linear(in_features=in_dim, out_features=out_dim, bias=bias)
    ...
    def forward(self, x_q: Tensor) -> Tensor:
        ...
        # [N, h, P, c] -> [N, P, h, c] -> [N, P, C],C=in_dim
...
class TransformerEncoder(nn.Module):
    ...
    Args:
        embed_dim (int): :math:`C_{in}` from an expected input of size :math:`(N, P, C_{in})`
        out_dim (int): 自注意力和MLP输出的token_dim，使用AttentionBlock中经过1*1卷积处理过的通道数
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.pre_norm_mha = nn.Sequential(
            ...
            attn_unit,
            DropPath(dropout) if dropout > 0. else nn.Identity()
        )
