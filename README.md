...
## This code is directly related to the manuscript I have submitted to the Journal "Scientific Reports".
...
| ImageNet classification (ratio={0.1, 0.05, 0.025, 0.01})       |                           [URL](https://pan.baidu.com/s/12rb3gGOvkbhrJeXXe_my1A),  提取码: a111                     |
| Cifar10 classification (ratio={0.25, 0.1, 0.018})     |                           [URL](https://pan.baidu.com/s/1oRqqpFWKIG7GCM1KZ-igkw), 提取码: a111                    |  
| Cifar100 classification (ratio={0.25, 0.1, 0.018})     |                           [URL](https://pan.baidu.com/s/1FoSnDkbPSwuSD0YHznMpdA), 提取码: a111                    |  
